...
<body class="container py-5">
    ...
    <form action="{{ route('user.authenticate') }}" method="POST">
       ...
       <a href="{{ route('users.editPassword') }}" class="text-decoration-none mt-2 d-block">Esqueceu a senha?</a>
        ...
        <button type="submit" class="btn btn-success custom-button mt-3">Entrar</button>
    </form>
